...
| batch\_size | 16         | RTX 5060 Ti 16GB 安全值 |
| encoder\_lr | 1e-4       | 预训练权重微调，慢 10 倍       |
| decoder\_lr | 1e-3       | 随机初始化，正常学习率          |
...
├── runs/
│   ├── train/
│   │   ├── exp_20260320_153000/   <-- 你的第一次训练
│   │   │   ├── training_log.csv
│   │   │   └── weights/
│   │   │       ├── best_dice.pt
│   │   │       └── ...
│   │   └── exp_20260320_184500/   <-- 你的第二次训练
│   ├── detect/
│   │   └── exp_20260320_190000/   <-- 你的单张图片测试结果
│   ├── val/
│   │   └── exp_20260320_191000/   <-- 测试集预测图片
│   └── diagnostic/
│       └── exp_20260320_192000/   <-- 红蓝绿分析图和报告
```
